...
public class puppyDAO {
    ...
    public void getAllPuppies() throws SQLException {
        ...
        while(rs.next()){
                    int puppy_id = rs.getInt("puppy_id");
    ...
    public Puppy getPuppy(String breed) throws SQLException {
        Puppy myPuppy = null;
        ...
        while(rs.next()){
            myPuppy = new Puppy(rs.getInt("puppy_id"),
                    rs.getString("breed"),
    ...
    public void addPuppy(Puppy P) throws SQLException {
        PreparedStatement statement = conn.prepareStatement(
                "INSERT INTO puppy (puppy_id, breed, temperament, size, sheds)" +
                        "Values" +
                        "(?,?,?,?,?)");
        int parameterIndex = 0;
        statement.setInt(++parameterIndex, P.getPuppy_id());
